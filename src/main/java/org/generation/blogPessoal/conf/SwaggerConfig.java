package org.generation.blogPessoal.conf;
...
public class SwaggerConfig {
	...
	private Contact contact() {
		return new Contact("Candido Cavaleiro", "https://github.com/Candido-Cavaleiro",
				"Desenvolvedor java junior full stack Angular Spring");
